...
public class LoginAndRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BotaoRegister.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                BotaoRegisterMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                BotaoRegisterMouseExited(evt);
            }
        });
    ...
    private void BotaoLoginMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoLoginMouseExited
        DashboardMenu m = new DashboardMenu();
        m.resetColor(jPanel3, corFraca);
    }//GEN-LAST:event_BotaoLoginMouseExited

    private void BotaoRegisterMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoRegisterMouseEntered
        DashboardMenu m = new DashboardMenu();
        m.resetColor(jPanel9, corForte);
    }//GEN-LAST:event_BotaoRegisterMouseEntered

    private void BotaoRegisterMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BotaoRegisterMouseExited
        DashboardMenu m = new DashboardMenu();
        Color corFraca1 = new Color(8,104,126);
        m.setColor(jPanel9, corFraca1);
    }//GEN-LAST:event_BotaoRegisterMouseExited
